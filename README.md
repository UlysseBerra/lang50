...
Game](https://greatlanguagegame.com/), for which legacy documentation and
[data](https://lars.yencken.org/datasets/great-language-game/) are available.
...
* [Ling Your Language](https://lingyourlanguage.com/) uses only audio snippets,
...
* [Language Squad](https://www.languagesquad.com/)'s originality is that it
...
* [Name That Language](https://namethatlanguage.org/) was a simpler version,
...
* Database
  * 156 languages in our SQL database (see `server`)
...
* Language Resources (documentation in `lang50/lang50/static`, audio files in
`lang50/server/src`, metadata and text snippets compiled from
`lang50/server/src` to `lang50/database.db`)
  * [UDHR
  project](https://www.ohchr.org/en/human-rights/universal-declaration/universal-declaration-human-rights/about-universal-declaration-human-rights-translation-project)
  * audio samples and scripts from [Omniglot](https://www.omniglot.com/)
  * legacy [UDHR in Unicode](https://unicode.org/udhr/) website
